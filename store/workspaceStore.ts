...
const defaultElementStyle = {
  rectangle: { fill: "#cfe1df", stroke: "#1f6f78", strokeWidth: 2, opacity: 1, fontSize: 16, ...BASE_FONT },
  circle:    { fill: "#f0dcc3", stroke: "#b36a21", strokeWidth: 2, opacity: 1, fontSize: 16, ...BASE_FONT },
  text:      { fill: "#1e2523", stroke: "transparent", strokeWidth: 0, opacity: 1, fontSize: 28, ...BASE_FONT, textAlign: "center" as const },
